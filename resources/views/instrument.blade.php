 ...
 <div class="row header-container justify-content-center">
    <div class="header">
        <h1>Instrument Management System</h1>
    </div>
</div>
 ...
 @if($layout == 'index')
  ...
  <div class="card-body">
    <h5 class="card-title">Enter The Information to New Istrument</h5>
	...
	<form action="{{ url('/store1') }}" method="post">
							...
							<div class="form-group">
								...
								<input name="Manufacturer" type="text" class="form-control"  placeholder="Enter Manufacturer">
							</div>
							<div class="form-group">
								<label >SerialNumber</label>
								<input name="SerialNumber" type="text" class="form-control"  placeholder="Enter Serial Number">
							</div>
							<div class="form-group">
								<label >ASTM</label>
								<input name="ASTM" type="text" class="form-control"  placeholder="Enter ASTM">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label >Vendor</label>
								<input name="Vendor" type="text" class="form-control"  placeholder="Enter Vendor">
							</div>
							<div class="form-group">
								<label >Contact</label>
